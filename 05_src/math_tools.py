...
import numexpr
#from langchain.chains.openai_functions import create_structured_output_runnable # Deprecated?
#from langchain_core.utils.function_calling import create_structured_output_runnable # alternative
